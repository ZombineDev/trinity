/***************************************************************************
 *   Copyright (C) 2009-2014 by Veselin Georgiev, Slavomir Kaslev et al    *
 ...
 * thread control library. The "true" CXXPTL library is part of the
 * fract benchmark project, and can be obtained via Subversion:
 *
